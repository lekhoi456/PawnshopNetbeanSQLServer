...
public class EditEmployee extends javax.swing.JFrame {
        ...
        try {
            ...
            for (int i = 0; i < employeeModel.getList().size(); i++) {
                if (employeeModel.getList().get(i).getEmpId() == empIdEdit) {
                    ...
                    if (employeeModel.getList().get(i).geteRole().equalsIgnoreCase("moderator")) {
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtEmployeeName, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 70, 260, 30));
        ...
        lblEmployeeName.setText("Edit Customer:");
