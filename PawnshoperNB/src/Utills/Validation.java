...
public class Validation {
    ...
    private static final String[] phoneArray = {"03", "09", "070", "079", "076", "078", "083", "085", "086", "081", "082", "056", "058", "059", "024", "028", "0203", "0204",
    ...
    public static boolean phoneNumber(String phoneNumber) {
        ...
        if (phoneNumber.length() == 10) {
            for (String phoneArray1 : phoneArray) {
                if (phoneNumber.startsWith(phoneArray1)) {
                    isValid = true;
                }
            }
        }
