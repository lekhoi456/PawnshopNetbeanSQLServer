...
public class StoreModel {
    ...
    public void updateMoney(int storeId, long cashFund, long interestCollected) throws SQLException {
        try {
            sqlST = "UPDATE Store SET CashFund = " + cashFund + ", InterestCollected = " + interestCollected + " WHERE StoreId = " + storeId;
            pst = conn.prepareStatement(sqlST);
            pst.executeUpdate();
            loadStore();
        } catch (SQLException e) {
